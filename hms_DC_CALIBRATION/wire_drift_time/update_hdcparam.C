...
void update_hdcparam()
{
   ...
   //open t_zero file
   ifstream ifs;
   ifs.open("tzero_data/tzero_weighted_avg_run259.txt");
        ...
        if ( ss >> t_zero)
        {
            ...
            if (id != '#') //skip comments   
            {
              ...
              line_NUM = line_NUM + 1;
                ...
                t_zero[line_NUM-1] = line;
                tzero[line_NUM-1] = atof(t_zero[line_NUM-1].c_str()); // convert string to double
                //cout << tzero[line_NUM-1] << endl;
        }       
    }     
...
TString hdc_param = "../../PARAM/HMS/DC/hdc.param";
...
TString tzero_dat = "../hms_dc_t_Zero/tzero.dat";
